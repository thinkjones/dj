...
**YOU ARE IN: `dj/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/dj/` (rig root) or other directories
...
**Your mail address:** `dj/polecats/furiosa`
**Your rig:** dj
**Your Witness:** `dj/witness`
...
| Ask Witness for help | `gt mail send dj/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`dj/witness`) when:
...
```bash
gt mail send dj/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
